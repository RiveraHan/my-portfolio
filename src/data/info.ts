export const info = {
  ...
  experience: [
    ...
    },
    {
      ...
      endDate: "Marzo 2021",
      description: [
        `Trabajé en el sitio web oficial de la empresa utilizando la tecnología NextJS para mostrar sus servicios y establecer su identidad en línea. El
        framework NextJS me permitió crear un sitio web rápido, dinámico y fácil de usar que comunica eficazmente la misión y las ofertas de la
        empresa.`
      ],
    },
  ],
  ...
  projects: [
    {
      ...
      liveUrl: "https://github.com/RiveraHan/tiktokClone",
    },
  ],
};
