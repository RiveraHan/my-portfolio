export const info = {
  ...
  about: `Ingeniero en Sistemas y Desarrollador Full Stack con 3 años de experiencia en software empresarial.`,
  ...
  experience: [
...

    {
      ...
      endDate: "Julio 2021",
      description: [
        `Desarrolle en la aplicación móvil TypeMatch (centrada en citas y conexiones). 
